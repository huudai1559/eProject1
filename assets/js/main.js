...
(function ($) {
	...
	function categorySubMenuToggle() {
		...
		if (screenSize <= 990) {
			$('.category-menu .menu-item-has-children .list').prepend('<span class="expand menu-expand"></span>');
			$('.category-menu .menu-item-has-children ul').slideUp();
		} 
		else {
			$('.category-menu .menu-item-has-children .list .menu-expand').remove();
	...
	amount.val(" Rs. " + rangeSlider.slider("values", 0) +
